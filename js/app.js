 ...
 *
 * @const {Element} carrito - Contenedor principal del carrito de compras.
 * @const {Element} contenedorCarrito - Cuerpo de la tabla donde se listarán los artículos del carrito.
 * @const {Element} vaciarCarritoBtn - Botón de vaciar carrito.
 * @const {Element} listaCursos - Contenedor de la lista de cursos
 * @let {object[]} aritculosCarrito - Array para almacenar los cursos agregados al carrito.
 */
